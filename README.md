...
***⚠️ 本项目有 [Deepseek® 网页版](https://chat.deepseek.com/) 参与,并由人类审计,请您在使用前仔细甄别***

***若您对AI的Coding能力有任何顾虑,请您删除下载的副本,并关闭此网页***
...
1. **下载官方驱动**  
   前往[[ MotorComm 官网 ] ](https://www.motor-comm.com/download?kw=&category=744&wd=1&tp=1)下载  
